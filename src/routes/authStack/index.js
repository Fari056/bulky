...
const AuthNavigation = () => {
  return (
    <Navigator screenOptions={{ headerShown: false }} initialRouteName={SCREEN.onboardings}>
      ...
      <Screen name={SCREEN.completeDriverProfile} component={Auth.CompleteDriverProfile} />
      <Screen name={SCREEN.driverProfileCompleted} component={Auth.DriverProfileCompleted} />
      <Screen name={SCREEN.scanDriverInsuranceCard} component={Auth.ScanDriverInsuranceCard} />
      <Screen name={SCREEN.cardScanner} component={Auth.CardScanner} />
      <Screen name={SCREEN.selectPaymentMethods} component={Auth.SelectPaymentMethods} />
    </Navigator>
  );
};
